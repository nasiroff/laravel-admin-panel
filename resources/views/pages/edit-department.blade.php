    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form action="{{ url("department/update/{$department->id}") }}" method="post" class="form-horizontal">
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name"
                                               value="{{ old('name') != "" ? old('name') : $department->name }}" id="department-name"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea placeholder="Department Description Here" class="form-control" name="description"
                                                  id="description">{{ old('description') != "" ? old('description') : $department->description }}</textarea>
