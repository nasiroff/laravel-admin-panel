                        ...
                        <form action="{!! url("employee/update/{$employee->id}") !!}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"
                                               value="{!!  old('name') != "" ? old('name') : $employee->first_name  !!}"
                                               name="name" class="form-control" id="fname"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email"
                                               ...
                                               name="email" class="form-control" id="email1" placeholder="Email here">
                                        ...
                                        <select class="form-control" name="department" id="department">
                                            ...
                                            @foreach($departments as $department)
                                                <option @if(old('department') == $department->id) selected
                                                        @elseif ($employee->department_id == $department->id) selected
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"
                                               ...
                                               name="phone" class="form-control" id="cono1"
                                               placeholder="Contact No Here">
                                        {!! $errors->first('phone', '<p class="help-block">:message</p>') !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Date of
                                        birth</label>
                                    <div class="col-sm-9">
                                        <input type="date"
                                               value="{!!  old('date_of_birth') != "" ? old('date_of_birth') : $employee->date_of_birth  !!}"
                                               name="date_of_birth" class="form-control" id="cono1"
                                               placeholder="Date of birth here">
                                        {!! $errors->first('date_of_birth', '<p class="help-block">:message</p>') !!}
                                    </div>
                                </div>
                                @if (isset($employee->photo) && !is_null($employee->photo))
                                    <div class="form-group row">
                                        <label for="photo"
                                               class="col-sm-3 text-right control-label col-form-label">Employee photo</label>
                                        <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="photo"
                                           class="col-sm-3 text-right control-label col-form-label">Photo</label>
                                    <div class="col-sm-9">
                                        <input type="file" accept=".jpg, .jpeg, .png" name="photo" class="form-control"
                                               id="photo" placeholder="Contact No Here">
